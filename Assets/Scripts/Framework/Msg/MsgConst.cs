namespace GuiFramework
{
    public class MsgConst
    {
        ...
        public const int ON_DIALOG_START = 20001; // 参数: dialogId(int), sessionId(int), targetInstanceId(int)
        public const int ON_DIALOG_NODE_ENTER = 20002; // 参数: sessionId(int), nodeId(int)
        public const int ON_DIALOG_CHOICE = 20003; // 参数: sessionId(int), nodeId(int), choiceIndex(int)
        public const int ON_DIALOG_END = 20004; // 参数: sessionId(int), dialogId(int)
